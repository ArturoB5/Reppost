				...
				<ul class="nav navbar-nav">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" style="position: relative;">
							...
							<span id="notification-badge" class="badge badge-danger" style="width:20px; position: absolute; top: 0; right: 0; background-color: red; color: white; border-radius: 50%; font-size: 12px; display: none;">0</span>
						</a>
		...
		<div class="container">
			...
			<div class="col-md-12">
				<div class="profile-info text-center">
					...
					$row = $query->fetch();
					// Obtener el total de tokens del usuario
					...
					<p><span class="info-label"><strong>Fecha de nacimiento:</strong></span>
						...
						$formattedDate = date('d / m / Y - ', strtotime($birthdate)); // Convertir a 'dd/mm/yyyy'
						// Calcular edad
					...
					$countryCode = $row['country']; // Código del país
					...
					<p><span class="info-label"><strong>Total de tokens:</strong></span> <?php echo htmlspecialchars(number_format($total_tokens, 8)); ?></p>
				...
				<div class="panel" style="border-radius: 30px;">
					<div class="panel-body" style="margin-top: -40px;">
						<div class="col-md-12 text-center">
							...
							ORDER BY friends.friends_id DESC LIMIT 6"); // Ordenar por ID descendente y limitar a 6
							...
							?>
								<div class="col-6 col-sm-4 col-md-2 text-center">
									<a href="profile_friend.php?member_id=<?php echo $row['member_id']; ?>">
										<img src="<?php echo $friend_image; ?>" alt="<?php echo $friend_name; ?>" class="img-thumbnail" style="width:100px;height:100px;border-radius: 50%;">
									</a>
