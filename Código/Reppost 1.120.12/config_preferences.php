                    ...
                    <div class="navbar-form navbar-search" role="search">
                        <form method="post" action="search.php" class="search-form">
                            <div class="input-group">
                                <input type="text" name="search" class="form-control search-query" placeholder="Buscar" style="width: 180px; margin-left: 7px;" required>
                            </div>
                        </form>
                    </div>
                </li>
    ...
    <div class="container mt-5">
        ...
        <div id="help">
            ...
            <div class="config-container">
                ...
                <p>Si crees que hubo un error o necesitas soporte, contactate con un moderador.</p>
                <a href="help.php">
                    <button class="report-btn">
            ...
            <div class="config-container">
                <h3>Politicas</h3>
                <p>Nuestras políticas garantizan la privacidad, seguridad y una experiencia justa para
                    todos los usuarios. Consulta nuestras normativas sobre el uso de datos, comportamiento
                    en la plataforma y derechos de los usuarios.</p>
                <a href="politics.php">
                    <button class="report-btn">
                        <i class="fa-solid fa-magnifying-glass"></i> Ver políticas
                    </button>
                </a>
            </div>
        </div>
