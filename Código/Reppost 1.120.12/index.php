...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="View/css/modal_index.css" />
                ...
                <div id="wrapper">
                    <div id="login" class="animate form">
                        <form method="post" action="login.php">
                            ...
                            <p>
                                <center>
                                    <a href="#toforgot">¿Olvidaste tu contraseña?</a> o
                                    <a href="help_index.php">¿Necesitas ayuda?</a>
                            </p>
                            </center>
                            </p>
                            <p class="change_link">
                        ...
                        if (isset($_GET['error'])) {
                            ...
                            switch ($_GET['error']) {
                                ...
                                case 'email_not_verified':
                                    $error_message = 'Aún no te has verificado. Por favor revisa tu correo.';
                                    break;
                                default:
...
- Un carácter especial (@, #, $, etc.).">
                            ...
                            <p class="signin button">
                                <input type="submit" style="margin-top: 20px" value="Registrate" />
                            </p>
                            <p class="terms-text" style="font-size: 14px; color: #555; text-align: center; margin-top: 10px;">
                                Al hacer clic en <strong>"Registrarte"</strong>, aceptas nuestras
                                <a href="politics_index.php" style="color: #007acc; text-decoration: none;">Condiciones y Política de privacidad,</a>
                                si necesitas nuestra asistencia da clic en <a href="help.php" style="color: #007acc; text-decoration: none;">ayuda</a>.
                            </p>
                            <p style="padding: 0px 0px 0px 30px" class="change_link">
                                ¿Ya estás registrado?
                                <a href="#tologin" style="margin-top: 20px" class="to_register">Ingresar</a>
                            </p>
                        </form>
                    </div>
                    <!-- Sección FORGOT PASSWORD -->
                    <div id="forgot" class="animate form">
                        <form action="forgot_password.php" method="post">
                            <h4>RECUPERA TU CONTRASEÑA</h4>
                            <hr>
                            <p style="position: relative;">
                                <label for="identifier">Ingresa tu correo o usuario</label>
                                <input id="identifier" name="identifier" required="required" type="text" placeholder="Correo o usuario" />
                                <i class="fa fa-envelope" style="position: absolute; left: 10px; top: 35px; color: rgb(97 160 159)"></i>
                            </p>
                            <p class="login button">
    ...
    <!-- Modal HTML (oculto) -->
    <div class="modal" id="loginAttemptsModal">
        <div class="modal-content">
            <h3>¿Olvidaste tu contraseña?</h3><br>
            <p>Hemos detectado varios intentos para iniciar sesión.
                <br>Si olvidaste tu contraseña, puedes recuperarla dando clic<a href="#toforgot" style="color: blue;"> aquí</a>.
            </p><br>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            <?php if (!empty($_SESSION['show_modal_login'])): ?>
                // Mostrar el modal
                let modal = document.getElementById('loginAttemptsModal');
                modal.style.display = 'block';
                <?php unset($_SESSION['show_modal_login']); ?>
            <?php endif; ?>
            // Botón "Cerrar"
            ...
            // 2) Clic “aquí” => cerrar modal
            const forgotLink = document.getElementById('goToForgotLink');
            if (forgotLink) {
                forgotLink.addEventListener('click', function(e) {
                    e.preventDefault();
                    let modal = document.getElementById('loginAttemptsModal');
                    modal.style.display = 'none';
                    window.location.hash = '#toforgot';
                });
            }
        });
    </script>
