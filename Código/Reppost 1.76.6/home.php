                ...
                <div class="col-md-12 col-sm-9">
                  <div class="alert">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      ...
                      <div class="butt-a">
                        <?php if ($member_id == $session_id): ?>
                          <!-- Sólo se muestran si el post me pertenece (soy el dueño) -->
                          <a href="edit_post.php?id=<?php echo $id; ?>" class="btn btn-info">
                            <i class="fa fa-edit"></i>
                          </a>
                          <a href="delete_post.php?id=<?php echo $id; ?>" class="btn btn-danger">
                            <i class="fa fa-trash"></i>
                          </a>
                        <?php endif; ?>
                        <!-- Estos botones se pueden mostrar a todos, si así lo deseas -->
                        <a href="share_post.php?id=<?php echo $id; ?>" class="btn btn-primary">
                          <i class="fa fa-share"></i>
                        </a>
                        <a href="report_post.php?id=<?php echo $id; ?>" class="btn btn-warning">
