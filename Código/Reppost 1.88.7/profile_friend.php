                ...
                <div class="col-md-12 mx-auto"><br>
                    <div class="profile-info text-center" style="border-radius: 30px;">
                        ...
                        <div style="display: flex; justify-content: center; align-items: center;">
                            <?php
                            // Verificar si ya se ha reportado al usuario
                            $check_reported = $conn->prepare("SELECT * FROM report_users WHERE reporter_id = :reporter_id AND reported_id = :reported_id");
                            ...
                            ?>
                            <!-- Botón Reportar -->
                            <button class="btn btn-warning <?php echo $disabled; ?>" data-toggle="modal" data-target="#reportModal<?php echo $profile_id; ?>" style="margin-right: 2px;">
                            ...
                            <form action="block_user.php" method="POST" style="margin: 0;">
                                ...
                                <button type="submit" class="btn btn-danger" style="margin-right: 2px;">
                                    <i class="fa fa-lock"></i> Bloquear
                                </button>
                            </form>
                            <!-- Botón Eliminar -->
                            <a href="delete_friend.php?id=<?php echo $row['member_id']; ?>" class="btn btn-danger" style="margin-right: 2px;">
