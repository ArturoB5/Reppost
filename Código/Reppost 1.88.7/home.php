                  ...
                  <div class="alert" id="post-<?php echo $id; ?>">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      ...
                      <div class="reaction-container" data-post-id="<?php echo $id; ?>">
                        <button class="btn btn-heart" style="padding: 6px 10px;">
                    ...
                    <div class="comments-section">
                      ...
                      while ($comment = $comments_query->fetch()) {
                        ...
                        $reaction_query = $conn->prepare("SELECT COUNT(*) AS total_reactions FROM reactions_comment WHERE comment_id = :comment_id");
                        ...
                        <div class="alert">
                          <div class="comment">
                            ...
                            <div class="reactions" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px">
                              ...
                              <div>
                                <button class="btn btn-heart" style="padding: 6px 10px;" data-comment-id="<?php echo $comment['comment_id']; ?>"><i class="fa fa-heart"></i></button><span> <?php echo $reaction_count; ?></span>
                              </div>
