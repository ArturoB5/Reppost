...
<body>
	...
	<div id="masthead">
		<div class="container">
			<div class="col-md-12 text-center" style="background-image: url(View/Images/app_images/background.jpeg); background-size: cover; background-position: center; background-repeat: no-repeat; border-bottom-left-radius: 20px; border-bottom-right-radius: 20px;">
				<br>
