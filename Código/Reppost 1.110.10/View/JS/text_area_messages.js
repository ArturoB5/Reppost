    ...
    try {
        ...
        messages.forEach((message) => {
            ...
            if (!isNaN(date.getTime())) {
                ...
                dateFormatted = date.toLocaleDateString([], { day: '2-digit', month: '2-digit', year: 'numeric' });
            } else {
                console.warn('Fecha inválida:', message.date_sent);
            }
            const messageHtml = `
                <div class="mb-3">
