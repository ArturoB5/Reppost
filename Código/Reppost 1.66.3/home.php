      ...
      <nav class="collapse navbar-collapse" role="navigation">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" id="notifications-dropdown" style="width: 300px; max-height: 300px; overflow-y: auto;">
              <li class="dropdown-header"></li>
              <!-- Aquí se llenarán las notificaciones dinámicamente -->
              <li><a href="#" class="text-muted text-center">No tienes notificaciones nuevas</a></li>
            </ul>
          </li>
        </ul>
        <div class="navbar-form navbar-search" role="search">
          <form method="post" action="search.php" class="search-form">
            <div class="input-group">
              <input type="text" name="search" class="form-control search-query" id="span5" placeholder="Buscar" style="margin-left: 220px;">
            </div>
          </form>
        </div>
      </nav>
