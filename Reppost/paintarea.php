...
<body><br>
    ...
    <input type="hidden" id="userName" value="<?php echo isset($username) ? $username : 'Desconocido'; ?>">
    ...
    ?>
    <div class="controls">
        <h4 style="color: black;"><b>Busca imágenes con</b></h4>
        <a href="https://www.pexels.com">
            <img src="https://images.pexels.com/lib/api/pexels.png" style="width: 100px; height:35px" />
        </a>
        <form id="search-form">
            <input type="text" id="query-input" placeholder="Escribe tu búsqueda" required style="margin-right: 10px;">
            <button type="submit"><i class="fa-solid fa-magnifying-glass"></i>Buscar</button>
        </form>
        <div id="photo-container"></div>
    </div><br>
    <div class="controls">
        <h4 style="color: black;"><b>Genera imágenes con</b></h4>
        <a href="https://starryai.com">
            <img src="https://files.readme.io/c6ab115-small-starryai-logo.png" style="width: 100px; height:25x; margin-top:-5px" />
        </a>
        <input type="text" id="promptInput" placeholder="Genera tu imágen" required />
        <button id="generateImage"><i class="fa-solid fa-wand-magic-sparkles"></i>Genera</button>
        <div id="loadingBarContainer" style="display:none;">
            <progress id="loadingBar" value="0" max="100"></progress>
        </div>
        <div id="responseContainer"></div>
        <div id="actionButtons" class="action-buttons" style="display:none;">
            <button id="viewFullscreen" style="display:none;">Ver imágen</button>
        </div>
        </center>
    </div><br><br>
</body>
<footer>
    ...
    <script src="View/JS/generate.js"></script>
