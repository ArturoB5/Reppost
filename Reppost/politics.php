...
<head>
    ...
    <title>Políticas de Uso - Reppost</title>
    <link rel="stylesheet" href="View/css/politics.css"> <!-- Estilos generales -->
    <link rel="stylesheet" href="View/css/dark_mode.css"> <!-- Estilos modo oscuro -->
</head>
...
<body>
    ...
    <div class="policies-container">
        ...
        <div class="policy-section">
            ...
            <p>
                <?php echo ($selectedLanguage === 'es')
                    ? 'Si tienes preguntas sobre nuestras políticas, puedes contactarnos en la ventana de ayuda.'
                    : 'If you have questions about our policies, you can contact us at help window.'; ?>
            </p>
        </div>
        <a href="config_preferences.php" class="back-btn">
